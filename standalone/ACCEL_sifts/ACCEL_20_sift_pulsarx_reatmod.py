...
if len(cands):
    ...
    print("#id   dm acc  F0 F1 S/N", file=open('candidates.txt', 'a'))
    for k,cand in enumerate(cands):
        print("%d\t%.3f\t%.15f\t%.15f\t%.15f\t%.2f" % (k+1, cand.DM, 0., cand.f, cand.z/cand.T/cand.T, cand.snr), file=open('candidates.txt', 'a'))
