...
cp $script_dir/DD_plans/ddplan_FAST_x2DS_ONE.txt . 
...
dedisperse_all_fil -v --psrfits -t 8 --ddplan ddplan_FAST_x2DS_ONE.txt --zapthre 3.0 -z kadaneF 8 4 zdot --incoherent --format presto --cont -f *.fits
