...
#cp /home/reatough/scripts/DD_plans/ddplan_FAST_M31x2DS_ONE.txt . 
cp $SCRIPT_DIR/DD_plans/ddplan_FAST_M31x2DS_ONE.txt . 
...
ulimit -a
stat *.fits
#/home/pulsarx/software/bin/dedisperse_all_fil -v --psrfits -t 8 --ddplan ddplan_FAST_M31x2DS_ONE.txt --zapthre 3.0 -z kadaneF 8 4 zdot --incoherent --format presto --cont -f *.fits
dedisperse_all_fil -v --psrfits -t 8 --ddplan ddplan_FAST_M31x2DS_ONE.txt --zapthre 3.0 -z kadaneF 8 4 zdot --incoherent --format presto --cont -f *.fits
